# 🚀 Einfache Anleitung: files.schels.info einrichten

## Schritt 1: Auf Server einloggen

**Option A: Über Hetzner Console (Web-Interface)**
1. Gehe zu https://console.hetzner.cloud
2. Wähle deinen Server aus
3. Klicke auf "Console" oder "VNC Console"
4. Du bist jetzt auf dem Server eingeloggt

**Option B: Über SSH** (falls funktioniert)
```bash
...
**Kopiere diesen kompletten Befehl und führe ihn auf dem Server aus:**
...
Nach dem Setup sollte Nextcloud unter **https://files.schels.info** erreichbar sein.
